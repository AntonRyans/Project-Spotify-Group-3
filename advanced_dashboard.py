...
def main():
    ...
    with c2:
        ...
        track_artist_map = albums[['track_id', 'artist_0']].merge(tracks[['id', 'explicit']], left_on='track_id', right_on='id')
        
        # Calculate proportion
        explicit_stats = track_artist_map.groupby('artist_0')['explicit'].apply(
    ...
    albums['release_year'] = pd.to_datetime(albums['release_date'], errors='coerce').dt.year
