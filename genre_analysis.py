...
#plt.figure()
#sb.boxplot(x='sum_of_genres', y='followers', data=df_adjusted)
...
sb.barplot(x='sum_of_genres', y='artist_popularity', data=df_adjusted, errorbar = None)
plt.title("Average Popularity by Sum of Genres")
plt.xlabel("Sum of Genres")
plt.ylabel("Average Popularity")
plt.show()

sb.barplot(x='sum_of_genres', y='followers', data=df_adjusted, errorbar = None)
plt.title("Average Popularity by Sum of Genres")
plt.xlabel("Sum of Genres")
plt.ylabel("Average Popularity")
plt.show()
